...
(* OASIS_START *)
(* DO NOT EDIT (digest: c97a0b632a9a310c860c654f6f3d80a2) *)
(*
     ...
     package =
       {
          ...
          description = Some "OCaml bindings to portmidi";
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lportmidi"])];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for portmidi";
                      doc_authors = ["Niki Yoshiuchi"];
                      doc_abstract = None;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocaml_portmidi"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
